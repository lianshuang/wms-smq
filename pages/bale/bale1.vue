	...
	<view>
		...
		<view class="operation">
			<view class="scanner">
				...
				<input class="scanner-input uni-input" cursor-spacing="10" type="text" placeholder="请扫描拣选单号" @confirm="nextStep()" focus v-model="formData.master_order_num" />
			</view>
			<!-- 底栏操作按钮 -->
